...
le_question.setStyleSheet("color: blue;")  
le_right_ans = QLineEdit()
le_right_ans.setStyleSheet("color: green;")
le_wrong_ans1 = QLineEdit()
le_wrong_ans1.setStyleSheet("color: red;")
le_wrong_ans2 = QLineEdit()
le_wrong_ans2.setStyleSheet("color: red;")
le_wrong_ans3 = QLineEdit()
le_wrong_ans3.setStyleSheet("color: red;")
